...
class cdRecMagPropertiesSchema(SchemaDict):
    ...
    dtypes = (float, NoneType, NoneType, float, NoneType, NoneType, float, float, float, float, float, NoneType, float, NoneType, float)
...
class cdHolographySchema(SchemaDict):
    ...
    dtypes = (NoneType, NoneType, list, cdImagePairsContainer, NoneType, float, float, NoneType)
...
class cdTriggerSchema(SchemaDict):
    ...
    dtypes = (float, float, NoneType, NoneType)
...
class cdCorrelatorDataSchema(SchemaDict):
    ...
    dtypes = (NoneType, NoneType, NoneType, NoneType, NoneType)
...
class cdDarkCurrentCorrectedSchema(SchemaDict):
    ...
    dtypes = (list, list, list, NoneType, list, NoneType)
...
class cdProcessedDataSchema(SchemaDict):
    ...
    dtypes = (cdDarkCurrentCorrectedSchema, NoneType, NoneType, NoneType, (NoneType,cdSpectraSchema), (NoneType,list), NoneType)
...
class rawDataSchema(SchemaDict):
    ...
    dtypes = ((NoneType,rdPolarizationSchema),
        dict,
        int,
        float,
        (NoneType,rdFluorescenceSchema),
        rdTriggerDumpSchema,
        int,
        float,
        bool,
...
class metaDataSchema(SchemaDict):
    ...
    dtypes = (str, str, str, list, (NoneType,str), str, NoneType, NoneType)
