...
class cdHolographySchema(SchemaDict):
    ...
    dtypes = (NoneType, NoneType, list, cdImagePairsContainer, NoneType, list, float, NoneType)
...
class cdProcessedDataSchema(SchemaDict):
    ...
    dtypes = (cdDarkCurrentCorrectedSchema, NoneType, NoneType, NoneType, NoneType, NoneType, NoneType)
...
class metaDataSchema(SchemaDict):
    ...
    dtypes = (str, str, str, list, NoneType, str, NoneType, NoneType)
