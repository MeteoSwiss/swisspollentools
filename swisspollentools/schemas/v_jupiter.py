...
class cdProcessedDataSchema(SchemaDict):
    ...
    dtypes = (cdDarkCurrentCorrectedSchema, NoneType, NoneType, NoneType, cdSpectraSchema, (list,NoneType), NoneType)
...
class metaDataSchema(SchemaDict):
    ...
    dtypes = (str, str, str, list, str, str, NoneType, NoneType)
